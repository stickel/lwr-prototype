...
// Labels
import BUTTON_SAVE from '@my/label/global/button.save';
import BUTTON_CANCEL from '@my/label/global/button.cancel';

export default class SimpleModalExample extends LightningModal {
    @api heading = '';
